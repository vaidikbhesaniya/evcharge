...
const Privacy = () => {
    return (
        <div className="max-w-4xl mx-auto p-8">
            ...
            <p className="mb-4">
                Welcome to EVPointer. We are committed to protecting your
                ...
                contact us at privacy@evpointer.com.
            </p>
            <p className="mb-4">
                When you visit our website{" "}
                <a
                    href="https://evpointer.vercel.app"
                    className="text-blue-500 underline"
                >
                    https://evpointer.vercel.app
                </a>{" "}
                (the "Site") and use our services, you trust us with your
                personal information. We take your privacy very seriously. In
                this privacy policy, we seek to explain to you in the clearest
                way possible what information we collect, how we use it, and
                what rights you have in relation to it. We hope you take some
                ...
                please discontinue use of our Site and our services.
            </p>
            <p className="mb-4">
                This privacy policy applies to all information collected through
                our Site, and/or any related services, sales, marketing, or
            ...
            <ul className="list-disc list-inside mb-4">
                <li>
                    ...
                    phone numbers; email addresses; mailing addresses; job
                    titles; and other similar information.
                </li>
                <li>
                ...
                <li>
                    ...
                    Facebook, Twitter, or other social media account.
                </li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-4">
                ...
                to fulfill business obligations. Specifically, we may need to
                process or share your data in the following situations:
            </p>
            <ul className="list-disc list-inside mb-4">
                <li>
                ...
                <li>
                    Other Users. When you share personal information or
                    otherwise interact with public areas of the Site, such
            ...
            <p className="mb-4">
                ...
                your name, email address, friends list, and profile picture, as
            ...
            <p className="mb-4">
                ...
                our Site is at your own risk. You should only access the Site
            ...
            <p className="mb-4">
                ...
                Site and updating the "Last Updated" date at the top of this
            ...
            <p className="mb-4">
                ...
                <a
                    href="mailto:privacy@evpointer.com"
                    className="text-blue-500 underline"
                >
                    vbcdevelopersorg@gmail.com
                </a>
                , by phone at , or by post to:
            </p>
