...
const Privacy = () => {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <p className="mb-4">
        Welcome to EVPointer. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at privacy@evpointer.com.
      </p>
      <p className="mb-4">
        When you visit our website <a href="http://www.evpointer.com" className="text-blue-500 underline">www.evpointer.com</a> (the "Site") and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what information we collect, how we use it, and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Site and our services.
      </p>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Social Media Login Data. We may provide you with the option to register using social media account details, like your Facebook, Twitter, or other social media account.</li>
      </ul>
      <p className="mb-4">
        All personal information that you provide to us must be true, complete, and accurate, and you must notify us of any changes to such personal information.
      </p>
      <h2 className="text-2xl font-bold mt-8 mb-4">2. How Do We Use Your Information?</h2>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Request feedback and to contact you about your use of our Site.</li>
        ...
        <li>To manage user orders and payments.</li>
        <li>To deliver and facilitate delivery of services to the user.</li>
        <li>To respond to user inquiries/offer support to users.</li>
        <li>To send you marketing and promotional communications.</li>
      </ul>
      <h2 className="text-2xl font-bold mt-8 mb-4">3. Will Your Information Be Shared With Anyone?</h2>
      <p className="mb-4">
        We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations. Specifically, we may need to process or share your data in the following situations:
      </p>
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Other Users. When you share personal information or otherwise interact with public areas of the Site, such personal information may be viewed by all users and may be publicly distributed outside the Site in perpetuity.</li>
      </ul>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">5. How Do We Handle Your Social Logins?</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">8. What Are Your Privacy Rights?</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        If you are a resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href="https://ec.europa.eu/newsroom/article29/items/612080" className="text-blue-500 underline">https://ec.europa.eu/newsroom/article29/items/612080</a>.
      </p>
      <h2 className="text-2xl font-bold mt-8 mb-4">9. Controls for Do-Not-Track Features</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">10. Do We Make Updates to This Policy?</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">11. How Can You Contact Us About This Policy?</h2>
      <p className="mb-4">
        If you have questions or comments about this policy, you may contact our Data Protection Officer (DPO) by email at <a href="mailto:privacy@evpointer.com" className="text-blue-500 underline">privacy@evpointer.com</a>, by phone at +123-456-7890, or by post to:
      </p>
      <address className="mb-4">
        EVPointer<br />
        Attn: Privacy Compliance<br />
        123 Electric Ave<br />
        Cityville, EV 12345<br />
        Country
      </address>
    </div>
  );
